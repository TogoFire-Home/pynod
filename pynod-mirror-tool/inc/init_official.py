...
def init(ver):
    ...
    if ver == 'v9':
        return {
        'fix': '',
        'upd' : 'eset_upd/v9/update.ver',
        'dll' : 'eset_upd/v9/dll/update.ver',
    ...
    if ver == 'v11':
        ...
        return {
        'fix': '',
        'upd' : 'eset_upd/v11/dll/update.ver',
        'dll' : 'eset_upd/v11/dll/update.ver',
    ...
    if ver == 'ep5':
        ...
        'upd' : 'eset_upd/ep5/dll/update.ver',          # Path where ep5 itself requests update.ver from the update server
        'dll' : 'eset_upd/ep5/dll/update.ver',          # Path where update.ver will be located on our mirror
        'name' : 'ESET NOD32 Endpoint Ver. 5'           # Description
        }   

    if ver == 'ep6':
        return {
        'fix': '/dll',                                  # Additional path
        'upd' : 'eset_upd/ep6.6/dll/update.ver',        # Path where ep6 itself requests update.ver from the update server
    ...
    if ver == 'ep9':
        return {
        'fix': '/dll',                                  # Additional path
        'upd' : 'eset_upd/ep9/dll/update.ver',          # Path where ep9 itself requests update.ver from the update server
    ...
    if ver == 'ep10':
        return {
        'fix': '/dll',                                  # Additional path
        'upd' : 'eset_upd/ep10/dll/update.ver',         # Path where ep10 itself requests update.ver from the update server
    ...
    if ver == 'ep11':
        return {
        'fix': '/dll',                                  # Additional path
        'upd' : 'eset_upd/ep11/dll/update.ver',         # Path where ep11 itself requests update.ver from the official server
    ...
    if ver == 'ep12':
        return {
        'fix': '/dll',                                  # Additional path
        'upd' : 'eset_upd/ep12/dll/update.ver',         # Path where ep12 itself requests update.ver from the official server
        ...
        print ("Undefined version", ver, "in init.py")
        sys.exit(1)
