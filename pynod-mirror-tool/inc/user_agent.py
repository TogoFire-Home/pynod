...
def user_agent (ver):
    ...
    if ver == 'v19':
        bzz =(
        'EAV Update (Windows; U; 64bit; BPC 19.0.11.0; OS: 10.0.19044 SP 0.0 NT; TDB 67572; CL 1.0.0; x64c; APP eav; PX 0; PUA 0; CD 1; RA 0; UNS 0; UBR 6332; HVCI 0; SHA256 1; WU 3; uPCU 19.0.14.0; ACS 1; TDT 0; LTS 1; NPU 0; HWF: 01073CD7-7235-2E7A-2352-87643B77124A; PLOC ru_ru; PCODE 106.0.0; PAR -1; ATH -1; DC 0; PLID 2HB-1KF-E9A; SEAT 8c802230; RET 0)',
        'EAV Update (Windows; U; 64bit; BPC 19.0.11.0; OS: 10.0.19044 SP 0.0 NT; TDB 67572; CL 1.0.0; x64c; APP eav; PX 0; PUA 0; CD 1; RA 0; UNS 0; UBR 6332; HVCI 0; SHA256 1; WU 3; uPCU 19.0.14.0; ACS 1; TDT 0; LTS 1; NPU 0; HWF: 01052DF5-3147-A35B-1571-A3412D12142B; PLOC ru_ru; PCODE 106.0.0; PAR -1; ATH -1; DC 0; PLID 3AA-2FF-A2B; SEAT 8c802230; RET 0)',
        'EAV Update (Windows; U; 64bit; BPC 19.0.11.0; OS: 10.0.19044 SP 0.0 NT;',
        'EAV Update (Windows; U; 64bit; BPC 19.0.11.0; OS: 10.0.19044 SP 0.0 NT; TDB 67572; CL 1.0.0; x64c;',
    ...
    if ver == 'ep12':
        bzz =(
        'EEA Update (Windows; U; 64bit; BPC 12.1.2057.3; OS: 10.0.19044 SP 0.0 NT; TDB 67664; CL 0.0.0; x64c; APP eea; PX 0; PUA 1; CD 0; RA 0; UNS 1; UBR 6575; HVCI 0; SHA256 1; WU 3; ACS 1; TDT 0; LTS 1; NPU 0; HWF: 0100EE9A-4655-9D5C-6876-201222F5AF83; PLOC ru_ru; PCODE 107.0.0; PAR -1; ATH -1; DC 0; PLID 34D-54D-1AB; SEAT 154b2454; RET 5003)'
        'EEA Update (Windows; U; 64bit; BPC 12.1.2057.3; OS: 10.0.19045 SP 0.0 NT; TDB 67664; CL 0.0.0; x64c; APP eea; PX 0; PUA 1; CD 0; RA 0; UNS 1; UBR 6466; HVCI 0; SHA256 1; WU 3; ACS 1; TDT 0; LTS 0; NPU 0; HWF: 01006A22-4BA2-512A-3432-4FA7D86C225A; PLOC ru_ru; PCODE 107.0.0; PAR -1; ATH -1; DC 0; PLID 37A-48B-5BA; SEAT 154b2454; RET 5003)',
        'EEA Update (Windows; U; 64bit; BPC 12.1.2057.3; OS: 10.0.19044 SP 0.0 NT; TDB 67664; CL 0.0.0; x64c; APP eea; PX 0; PUA 1; CD 0; RA 0; UNS 1; UBR 6575; HVCI 0; SHA256 1; WU 3; ACS 1; TDT 0; LTS 1; NPU 0; HWF: 0100D6D5-7B1D-F1A5-44F1-0BE2460EBB78; PLOC ru_ru; PCODE 107.0.0; PAR -1; ATH -1; DC 0; PLID 32D-C7F-5KB; SEAT 154b3474; RET 5003)',
        'EEA Update (Windows; U; 64bit; BPC 12.1.2057.3; OS: 10.0.19044 SP 0.0 NT; TDB 67664; CL 0.0.0; x64c; APP eea; PX 0; PUA 1; CD 0; RA 0; UNS 1; UBR 6575; HVCI 0; SHA256 1; WU 3; ACS 1; TDT 0; LTS 1; NPU 0; HWF: 0100EE9A-4655-9D5C-6876-C01222F5AF83; PLOC ru_ru; PCODE 107.0.0; PAR -1; ATH -1; DC 0; PLID 32D-48B-5DD; SEAT 154b3474; RET 5003)',
        'EEA Update (Windows; U; 64bit; BPC 12.1.2057.3; OS: 10.0.19045 SP 0.0 NT; TDB 67662; CL 0.0.0; x64c; APP eea; PX 0; PUA 1; CD 0; RA 0; UNS 1; UBR 6466; HVCI 0; SHA256 1; WU 3; ACS 1; TDT 0; LTS 0; NPU 0; HWF: 0100A1A3-B4C3-6489-F572-BDA2AFDA6442; PLOC uk_ua; PCODE 107.0.0; PAR -1; ATH -1; DC 0; PLID 33A-57A-6KA; SEAT 154b3474; RET 5003)'
            )
        return random.choice(bzz)
